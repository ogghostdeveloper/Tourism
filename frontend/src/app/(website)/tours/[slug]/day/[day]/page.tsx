          ...
          <div className="lg:col-span-1">
            <div className="sticky top-32 bg-black text-white p-8">
              ...
              <p className="text-gray-300 mb-8">
                This is just one part of the {tour.title} journey. Customize it to your liking.
              </p>
              <Link
                href="/enquire"
                className="block w-full bg-white text-black py-4 text-sm font-medium uppercase tracking-wider hover:bg-gray-200 transition-colors text-center"
              >
                Enquire Now
              </Link>
            </div>
