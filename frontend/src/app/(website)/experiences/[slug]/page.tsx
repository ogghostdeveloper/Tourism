        ...
        <div className="mt-40 flex flex-col gap-40">
          ...
          <div className="relative group">
            <div className="flex items-center justify-between mb-8 pb-4 border-b border-black/5">
              <h3 className="font-mono text-xs text-amber-600 uppercase tracking-[0.4em] font-bold">
                // regional geodata
              </h3>
              <span className="font-mono text-[8px] text-gray-400 uppercase tracking-widest font-bold">
