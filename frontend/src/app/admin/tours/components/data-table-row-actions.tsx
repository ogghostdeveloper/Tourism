        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[160px] rounded-none">
                    <Link href={`/admin/tours/${tour.id || tour._id}/edit`}>
                        <DropdownMenuItem className="text-green-600 focus:text-green-600 data-[variant=default]:text-green-600 data-[variant=default]:focus:bg-green-50 rounded-none">
                            <Pencil className="mr-2 h-4 w-4 text-green-500 focus:text-green-500 data-[variant=default]:text-green-500" /> Edit
                        </DropdownMenuItem>
                    </Link>
                    <Link href={`/admin/tours/${tour.id || tour._id}`}>
