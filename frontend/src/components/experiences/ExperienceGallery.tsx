...
export default function ExperienceGallery({ images }: ExperienceGalleryProps) {
  ...
  // Ensure we have at least 3 images for the layout, otherwise duplicate (just for demo safety, though data has 3)
  const displayImages =
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:h-[70vh] min-h-[600px]">
          ...
          <div className="md:col-span-4 flex flex-col gap-4 h-full">
            ...
            >
              <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-700 z-10" />
              <img
                src={displayImages[2] || displayImages[0]} // Fallback if 3rd missing
                alt="Atmosphere"
                className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105"
              />
            </motion.div>
